...
def build_stateweaver_cache_row(
    ...
    matched_prefix_tokens = int(getattr(req, "num_matched_prefix_tokens", 0) or 0)
    ...
    return {
        ...
        "radix_prefix_match_len": matched_prefix_tokens,
